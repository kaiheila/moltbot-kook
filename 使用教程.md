...
>
> **迁移提示**：插件已从旧包名 `@kookapp/moltbot-kook` 迁移到 `@kookapp/openclaw-kook`。如果你之前安装过旧包，请先卸载旧包，再安装新包。

![Moltbot + Kook](assets/20260130-110226.jpg)

## 第一步：安装 Moltbot/Clawdbot/OpenClaw

**如果你已经安装了 Moltbot、Clawdbot 或 OpenClaw，请直接跳到 [第二步](#第二步安装-kook-插件)。**


### 1.1 安装 Moltbot/Clawdbot/OpenClaw

环境要求及安装过程可以直接查看官方文档： https://docs.openclaw.ai/start/getting-started
...
服务会在后台运行，默认监听 `http://127.0.0.1:18789`。
...
配置文件通常位于（以 OpenClaw 为例）：
- **Linux/Mac**: `~/.openclaw/config.json`
